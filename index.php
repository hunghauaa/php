<?php
	...
	$query = "SELECT * FROM post ORDER BY created_at desc limit 7,6";
	...
	$query_post1 = "SELECT * FROM post WHERE id = 7";
	$result_post1 = $conn->query($query_post1);
	$posts1 = array();
	while ($row = $result_post1->fetch_assoc()) {
		$posts1[] = $row;

	 }


	$query_post2 = "SELECT * FROM post ORDER BY created_at desc limit 0,6";
	$result_post2 = $conn->query($query_post2);
	$posts2 = array();
	while ($row = $result_post2->fetch_assoc()) {
		$posts2[] = $row;
							...
							<div class="col-md-12">
								<div class="post post-thumb">
									...
									<div class="post-body">
										...
										<h3 class="post-title"><?php echo $post1['title']; ?></a></h3>
									</div>
								</div>
							</div>
						<?php } ?>
							...
							<div class="col-md-6">
								<div class="post">
									<a class="post-img" href="blog-post.html"><img src="<?php echo $post2['thumbnail'];?>"alt="" width="400px" height="300px"></a>
									<div class="post-body">
										<div class="post-meta">
